...
# WhatsApp Coordinator Notification Test Script
# Tests sending WhatsApp messages to verify the integration works
#
# Usage:
#   ./test_whatsapp.sh "054-YOUR-NUMBER"
#   ./test_whatsapp.sh "0541234567"
#   ./test_whatsapp.sh "+972541234567"
...
echo -e "${BLUE}"
echo "=================================================="
echo "  WhatsApp Coordinator Test"
echo "=================================================="
echo -e "${NC}"
...
cd "$SCRIPT_DIR"
python test_whatsapp_coordinator.py --phone "$PHONE_NUMBER"
