...
### table schema 
    child_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    city character varying(255) COLLATE pg_catalog."default" NOT NULL, - we will use the city as full address
    ...
    diagnosis_date date,
    marital_status character varying(50) COLLATE pg_catalog."default" NOT NULL, - must be one from the enum
    ...
    tutoring_status character varying(50) COLLATE pg_catalog."default" NOT NULL - must be one from the enum
    CONSTRAINT childsmile_app_children_pkey PRIMARY KEY (child_id)
```sql
INSERT INTO childsmile_app_children (childfirstname, childsurname, registrationdate, lastupdateddate, gender, responsible_coordinator, city, child_phone_number, treating_hospital, date_of_birth, medical_diagnosis, diagnosis_date, marital_status, num_of_siblings, details_for_tutoring, additional_info, tutoring_status)
VALUES ('אביגיל', 'גולדשטיין', current_timestamp, current_timestamp, TRUE, 'ליה צוהר', 'יוסף גדיש 12 עכו', '050-3334567', 'רמבם', '2015-01-01', 'לוקמיה', '2021-12-31', 'נשואים', 2, '', '', 'למצוא_חונך');
INSERT INTO childsmile_app_children (childfirstname, childsurname, registrationdate, lastupdateddate, gender, responsible_coordinator, city, child_phone_number, treating_hospital, date_of_birth, medical_diagnosis, diagnosis_date, marital_status, num_of_siblings, details_for_tutoring, additional_info, tutoring_status)
VALUES ('אביתר', 'אזולאי', current_timestamp, current_timestamp, TRUE, 'ליה צוהר', 'ביאליק 32 רמת גן', '050-3324561', 'שיבא', '2014-01-01', 'לימפומה', '2021-12-31', 'גרושים', 3, '', '', 'לא_רוצים');
INSERT INTO childsmile_app_children (childfirstname, childsurname, registrationdate, lastupdateddate, gender, responsible_coordinator, city, child_phone_number, treating_hospital, date_of_birth, medical_diagnosis, diagnosis_date, marital_status, num_of_siblings, details_for_tutoring, additional_info, tutoring_status)
VALUES ('אפרים', 'ביטון', current_timestamp, current_timestamp, TRUE, 'ליה צוהר', 'סוקולוב 50 חולון', '050-3331567', 'שניידר', '2013-01-01', 'מדובלסטומה', '2021-12-31', 'אין', 4, '', '', 'למצוא_חונך_בעדיפות_גבוה');
...
INSERT INTO childsmile_app_children (childfirstname, childsurname, registrationdate, lastupdateddate, gender, responsible_coordinator, city, child_phone_number, treating_hospital, date_of_birth, medical_diagnosis, diagnosis_date, marital_status, num_of_siblings, details_for_tutoring, additional_info, tutoring_status)
VALUES ('אבירם', 'מנגיסטה', current_timestamp, current_timestamp, TRUE, 'ליה צוהר', 'המלאכה 3 דימונה', '058-3334567', 'סורוקה', '2013-01-01', 'ניורובלסטומה', '2021-12-31', 'פרודים', 2, '', '', 'למצוא_חונך');
-- now insert into childsmile_app_healthy
/*
