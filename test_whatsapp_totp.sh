...
# WhatsApp TOTP Login Code Test Script
# Tests sending WhatsApp TOTP codes to verify the integration works
#
# Usage:
#   ./test_whatsapp_totp.sh "054-YOUR-NUMBER"
#   ./test_whatsapp_totp.sh "0541234567"
#   ./test_whatsapp_totp.sh "+972541234567"
...
echo -e "${BLUE}"
echo "=================================================="
echo "  WhatsApp TOTP Login Code Test"
echo "=================================================="
echo -e "${NC}"
...
cd "$SCRIPT_DIR"
python test_whatsapp_totp.py --phone "$PHONE_NUMBER"
