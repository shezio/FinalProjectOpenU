...
const NewFamiliesReport = () => {
  ...
  const fetchData = () => {
    ...
    axios
      ...
      .then((response) => {
        setFamilies(response.data.new_families || []);
      })
      .catch((error) => {
        console.error("Error fetching new families report:", error);
        ...
        <div className="filter-create-container">
          <div className="actions">
            <button
              ...
              onClick={() => exportNewFamiliesToExcel(families, t)}
            >
              <img src="/assets/excel-icon.png" alt="Excel" />
            </button>
            <button
              className="export-button pdf-button"
              onClick={() => exportNewFamiliesToPDF(families, t)}
            >
...
export default NewFamiliesReport;