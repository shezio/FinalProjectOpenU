...
VALUES 
(current_timestamp, current_date - interval '7 days', 34,'המפגש עם החניך שלי היה מוצלח מאוד היום. והצליח לפתור את התרגילים. שמחתי לראות את ההתקדמות שלו. יצרנו קשר טוב והרגשתי שהוא סומך עלי יותר מבפגישות הקודמות.'
 , 'שיחקנו במשחק קבוצתי', 'נביא דפים לציור בפעם הבאה', ''),
(current_timestamp, current_date - interval '6 days', 35,'בפגישה עם החניך שלי היום התמקדנו בשיחה עמוקה. הוא התקשה קצת, אבל בסוף הפגישה הרגשתי שהצלחתי להסביר לו בצורה ברורה..'
, '', '', ''),
(current_timestamp, current_date - interval '5 days', 36, 'היה לי מפגש משמעותי עם החניך שלי היום. הרגשתי שיש בינינו חיבור מיוחד. אני רואה שיפור משמעותי בתקשורת בינינו. בסוף המפגש שיחקנו משחק והוא ממש נהנה. הוא ביקש שאביא עוד משחקים בפעם הבאה.'
,'חייך באופן מיוחד בסוף הפגישה'
,'שבוע הבא אעדר - צריך למצוא מחליף', '');
