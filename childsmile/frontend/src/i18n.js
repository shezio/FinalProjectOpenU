...
const resources = {
  en: {
    translation: {
      ...
      "Error fetching settlements data": "Error fetching settlements data",
      ...
      "Age must be at least 13": "Age must be at least 13",
      "גיל מינימלי להרשמה הוא 13": "Minimum registration age is 13",
      "Date cannot be more than 120 years ago": "Date cannot be more than 120 years ago",
      "Birth date updated successfully": "Birth date updated successfully",
      "Error updating birth date": "Error updating birth date",
      ...
      "Volunteer/Tutor Name": "Volunteer/Tutor Name",
      "Select Volunteer/Tutor": "Select Volunteer/Tutor",
      "Volunteer/Tutor Name is required": "Volunteer/Tutor Name is required",
      "Use this name?": "Use this name?",
      "Use this name": "Use this name",
      "No options": "No options",
      "Bulk Edit Volunteer Name": "Bulk Edit Volunteer Name",
      "From Volunteer": "From Volunteer",
      "To Volunteer": "To Volunteer",
      "Matching feedbacks": "Matching feedbacks",
      "Update Feedbacks": "Update Feedbacks",
      "Please select the volunteer to reassign from": "Please select the volunteer to reassign from",
      "Please choose the new volunteer name": "Please choose the new volunteer name",
      "No feedbacks found for the selected volunteer": "No feedbacks found for the selected volunteer",
      "Feedbacks updated successfully": "Feedbacks updated successfully",
      "Failed to update feedbacks": "Failed to update feedbacks",
      ...
      "Update email address": "Update email address (Optional)",
      ...
      "Family details updated successfully!": "Family details updated successfully!",
      "Now updating child ID. This will update all related records in the system.": "Now updating child ID. This will update all related records in the system.",
      "Are you sure you want to change the child ID? This will update all related records in the system.": "Are you sure you want to change the child ID? This will update all related records in the system.",
      "Child ID updated successfully!": "Child ID updated successfully!",
      "Error updating child ID": "Error updating child ID",
      "ID update failed": "ID update failed",
      ...
      "Export Old Audit Logs": "Export Old Audit Logs",
      "Data Summary": "Data Summary",
      "Records to Export": "Records to Export",
      "Date Range": "Date Range",
      "Cutoff Date (90 days)": "Cutoff Date (90 days)",
      "Export Filename": "Export Filename",
      "Important Information": "Important Information",
      "All data will be exported to CSV and zipped before deletion": "All data will be exported to CSV and zipped before deletion",
      "Check the 1st and last items in the CSV to verify the correct date range": "Check the 1st and last items in the CSV to verify the correct date range",
      "The exported dates MUST match the filename dates shown above": "The exported dates MUST match the filename dates shown above",
      "Only logs OLDER than 90 days will be affected": "Only logs OLDER than 90 days will be affected",
      "Upload the exported ZIP to Google Drive immediately for backup": "Upload the exported ZIP to Google Drive immediately for backup",
      "The filename includes the exact export timestamp for audit purposes": "The filename includes the exact export timestamp for audit purposes",
      "I understand that this action will permanently delete": "I understand that this action will permanently delete",
      "audit log records older than 90 days. I have saved the exported CSV as backup.": "audit log records older than 90 days. I have saved the exported CSV as backup.",
      "Export & Purge": "Export & Purge",
      "No audit logs older than 90 days to purge": "No audit logs older than 90 days to purge",
      "audit logs exported successfully to": "audit logs exported successfully to",
      "No deletion has occurred yet.": "No deletion has occurred yet.",
      "Check Google Drive for backup.": "Check Google Drive for backup.",
      "Cancel": "Cancel",
      "Select a file": "Select a file",
      "Please select a file": "Please select a file",
      "Please select an .xlsx file": "Please select an .xlsx file",
      "Select Excel File": "Select Excel File",
      "Select Excel File (.xlsx)": "Select Excel File (.xlsx)",
      "Dry Run (Preview)": "Dry Run (Preview)",
      "Dry Run": "Dry Run",
      "Preview without importing": "Preview without importing",
      "Import": "Import",
      "Processing": "Processing",
      "Validate": "Validate",
      "Instructions": "Instructions",
      "Excel file must have columns: שם פרטי, שם משפחה, תעודת זהות, מייל, סוג התנדבות, etc.": "Excel file must have columns: שם פרטי, שם משפחה, תעודת זהות, מייל, סוג התנדבות, etc.",
      "First do a dry-run to validate data": "First do a dry-run to validate data",
      "Then upload without dry-run to import": "Then upload without dry-run to import",
      ...
      "Importing...": "Importing...",
      // Staff Profile Fields Translations
      "Israeli ID": "Israeli ID",
      "Birth Date": "Birth Date",
      ...
      "City": "City",
      "years": "years",
      "For use of management staff only": "For use of management staff only",
      "Optional demographic fields for reporting": "Optional demographic fields for reporting",
      "Not available for Tutor or General Volunteer only roles": "Not available for Tutor or General Volunteer only roles",
      "Demographic Information": "Demographic Information",
      "Basic Information": "Basic Information",
      "Staff Information": "Staff Information",
      "View staff information": "View staff information",
    }
  },
  he: {
    translation: {
      ...
      "feedback_report": "דוח משובים",
      "Feedback Report": "דוח משובים",
      "Possible Duplicate Families Detected": "⚠️ זוהו משפחות דומות אפשריות",
      "The following existing families share key details. Click a row to compare side-by-side.": "המשפחות הבאות חולקות פרטים מזהים. לחץ על שורה להשוואה צד לצד.",
      "Potential duplicates found": "כפילויות אפשריות שנמצאו",
      "Field": "שדה",
      "Old Value": "ערך קודם",
      "New Value": "ערך חדש",
      "Field Changes": "שינויי שדות",
      "New Family": "משפחה חדשה",
      "Existing": "קיימת",
      "If you are sure this is a different family, you can proceed. Otherwise, close this window and correct the highlighted fields.": "אם אתה בטוח שמדובר במשפחה שונה, ניתן להמשיך. אחרת, סגור חלון זה ותקן את השדות המסומנים.",
      "Close & Fix": "סגור ותקן",
      "Back to List": "חזור לרשימה",
      "Create Anyway": "צור בכל זאת",
      ...
      "Error fetching settlements data": "שגיאה בטעינת נתוני יישובים",
      ...
      "Show Details": "פרטים נוספים",
      "Birth Date": "תאריך לידה",
      "Age must be at least 13": "הגיל חייב להיות לפחות 13",
      "גיל מינימלי להרשמה הוא 13": "גיל מינימלי להרשמה הוא 13",
      "Date cannot be more than 120 years ago": "התאריך לא יכול להיות לפני יותר מ-120 שנה",
      ...
      "Family Details for Group Removal": "פרטים להסרת משפחה מקבוצה",
      ...
      "City Change": "שינוי עיר",
      "City updated successfully": "העיר עודכנה בהצלחה",
      "Changing a city of residence can have an actual effect on current matches": "שינוי עיר מגורים יכול להשפיע על התאמות נוכחיות",
      "Would you like to delete current tutorships for rematching?": "האם תרצה למחוק חונכויות קיימות לצורך התאמה מחדש?",
      ...
      "Age must be between 13 and 100.": "גיל חייב להיות בין 13 ל-100.",
      ...
      "Is In Frame": 'האם נמצא במסגרת',
      "Coordinator Comments": 'הערות הרכז',
      ...
      "Invalid ID format. Israeli ID must be exactly 9 digits.": "פורמט ת.ז לא תקין. ת.ז ישראלית חייבת להיות בדיוק 9 ספרות.",
      "Invalid phone format. Phone must be exactly 10 digits starting with 0.": "פורמט טלפון לא תקין. טלפון חייב להיות בדיוק 10 ספרות ומתחיל ב-0.",
      "ID updated successfully": "ת.ז עודכן בהצלחה",
      "Phone updated successfully": "טלפון עודכן בהצלחה",
      "This ID already exists in the system.": "ת.ז זו כבר קיימת במערכת.",
      "This phone number already exists in the system.": "מספר טלפון זה כבר קיים במערכת.",
      "You do not have permission to update IDs.": "אין לך הרשאה לעדכן תעודות זהות.",
      "You do not have permission to update phone numbers.": "אין לך הרשאה לעדכן מספרי טלפון.",
      "Error updating ID": "שגיאה בעדכון ת.ז",
      "Error updating phone": "שגיאה בעדכון טלפון",
      ...
      'Coordinator Chat': 'צ\'אט קואורדינטורים',
      'Roles': 'תפקידים',
      ...
      "Families Missing Data Report": "דוח משפחות עם נתונים חסרים",
      "Missing Fields": "שדות חסרים",
      "Enter": "הכנס",
      "Saving...": "שומר...",
      "No families with missing data": "אין משפחות עם נתונים חסרים",
      "No families missing": "אין משפחות",
      "All Missing": "כל החסרים",
      "Missing Phone": "ללא טלפון",
      "Missing Diagnosis Date": "ללא תאריך אבחון",
      "Missing Coordinator": "ללא רכז",
      "No Phone": "אין טלפון",
      "No Diagnosis Date": "אין תאריך אבחון",
      "No Coordinator": "אין רכז",
      "No Hospital": "אין בית חולים",
      "No Medical Diagnosis": "אין אבחנה רפואית",
      "No Parent Name": "אין שם הורה",
      "No Medical State": "אין מצב רפואי",
      "No Child Phone": "אין טלפון ילד",
      "No Tutoring Details": "אין פרטי חונכות",
      "No Additional Info": "אין מידע נוסף",
      "Missing Hospital": "ללא בית חולים",
      "Missing Medical Diagnosis": "ללא אבחנה רפואית",
      "Missing Parent Name": "ללא שם הורה",
      "Missing Medical State": "ללא מצב רפואי",
      "Missing Child Phone": "ללא טלפון ילד",
      "Missing Tutoring Details": "ללא פרטי חונכות",
      "Missing Additional Info": "ללא מידע נוסף",
      ...
      "Incomplete Task": "משימה פתוחה",
      "There is an open task on this tutorship - approve anyway?": "קיימת לפחות משימה פתוחה אחת על חונכות זו - להמשיך בכל זאת?",
      "Yes": "כן",
      "No": "לא",
      ...
      'Approved by Families and Tutors coordinators': 'פעיל',
      ...
      "Volunteer/Tutor Name": "שם המתנדב/חונך",
      "Select Volunteer/Tutor": "בחר מתנדב/חונך",
      "Volunteer/Tutor Name is required": "חובה למלא שם מתנדב/חונך",
      "Use this name?": "להשתמש בשם זה?",
      "Use this name": "השתמש בשם זה",
      "No options": "אין אפשרויות",
      "Bulk Edit Volunteer Name": "עריכה מרוכזת של שם מתנדב",
      "From Volunteer": "מהמתנדב",
      "To Volunteer": "למתנדב",
      "Matching feedbacks": "משובים תואמים",
      "Update Feedbacks": "עדכן משובים",
      "Please select the volunteer to reassign from": "יש לבחור את המתנדב שממנו לשנות",
      "Please choose the new volunteer name": "יש לבחור את שם המתנדב החדש",
      "No feedbacks found for the selected volunteer": "לא נמצאו משובים עבור המתנדב שנבחר",
      "Feedbacks updated successfully": "המשובים עודכנו בהצלחה",
      "Failed to update feedbacks": "עדכון המשובים נכשל",
      ...
      "Each tutor-child match receives a grade based ONLY on distance:": "כל התאמה מקבלת ציון בהתבסס רק על מרחק:",
      "Scoring Formula": "נוסחת ציון",
      ...
      'Distance Categories': "קטגוריות מרחק",
      'Grade': "ציון",
      'distance': "מרחק",
      'Over 50 km': "יותר מ-50 קילומטר",
      '0 km': "0 קילומטר",
      '25 km': "25 קילומטר",
      '50 km': "50 קילומטר",
      '(Invalid/Penalty)': "(לא תקין/קנס)",
      'Key Points': "נקודות חשובות",
      'Age is NOT a factor in matching': "גיל אינו גורם בהתאמה",
      'Closer distance = Higher grade': "מרחק קרוב יותר = ציון גבוה יותר",
      'Matches over 50km are automatically rejected': "התאמות מעל 50 קילומטרים נדחות באופן אוטומטי",
      'Matches are sorted by grade within gender groups': "התאמות ממוינות לפי ציון לפי חלוקה לקבוצות  - אותו המין או המין ההפכי",
      ...
      'Search Tutor': 'חפש חונך',
      'Search by name, city, or age': 'חפש לפי שם, עיר או גיל',
      'No tutors found': 'לא נמצאו חונכים',
      ...
      "Family details updated successfully!": "פרטי המשפחה עודכנו בהצלחה!",
      "Now updating child ID. This will update all related records in the system.": "כעת מעדכנים את מזהה החניך. פעולה זו תעדכן את כל הרשומות הקשורות במערכת.",
      "Are you sure you want to change the child ID? This will update all related records in the system.": "האם אתה בטוח שברצונך לשנות את מזהה החניך? פעולה זו תעדכן את כל הרשומות הקשורות במערכת.",
      "Child ID updated successfully!": "מזהה החניך עודכן בהצלחה!",
      "Error updating child ID": "שגיאה בעדכון מזהה החניך",
      "ID update failed": "עדכון המזהה נכשל",
      "ID update failed, but family details were saved": "עדכון המזהה נכשל, אך פרטי המשפחה נשמרו",
      "Error updating family details. ID was not changed.": "שגיאה בעדכון פרטי המשפחה. המזהה לא שונה.",
      "Invalid ID format. Israeli ID must be exactly 9 digits.": "פורמט מזהה שגוי. מזהה ישראלי חייב להיות בדיוק 9 ספרות.",
      ...
      'Cannot skip a status': 'לא ניתן לדלג על סטטוס - יש להעביר את המשימה ל"בביצוע" תחילה',
      "Initial Family Details": "פרטי משפחה ראשוניים",
      "Initial Family Data": "פרטי משפחה ראשוניים",
      "Tutee Match Details": "פרטי התאמת חניך",
      "Phones": "טלפונים",
      "Names": "שמות",
      ...
      'Preferences': 'העדפות החונך',
      'Enter preferences...': 'הזן העדפות...',
      'Select a marital status': 'בחר מצב משפחתי',
      'Enter tutee wellness info...': 'הזן מידע על מצב רפואי של החניך...',
      'Tutee Wellness': 'מצב רפואי נוכחי',
      'Relationship Status': 'מצב משפחתי',
      'Tutorship Details': 'פרטי חונכות',
      ...
      'Volunteer Comments': 'הערות המתנדב',
      'Click to see comments': 'לחץ כדי לראות הערות',
      'Comments saved successfully': 'ההערות נשמרו בהצלחה!',
      'Error saving comments': 'שגיאה בשמירת ההערות',
      'Enter comments...': 'הזן הערות...',
      'Save': 'שמור',
      ...
      "logs": "רשומות",
      "Selected": "נבחרו",
      "Export Old Audit Logs": "ייצוא רשומות יומן מערכת ישנות",
      "Data Summary": "סיכום הנתונים",
      "Records to Export": "רשומות לייצוא",
      "Date Range": "טווח תאריכים",
      "Cutoff Date (90 days)": "תאריך ההפרדה (90 ימים)",
      "Export Filename": "שם קובץ הייצוא",
      "Important Information": "מידע חשוב",
      "All data will be exported to CSV and zipped before deletion": "כל הנתונים יוצאו לCSV ויוצפנו לפני מחיקה",
      "Check the 1st and last items in the CSV to verify the correct date range": "בדוק את הפריט הראשון והאחרון בCSV כדי לאמת את טווח התאריכים הנכון",
      "The exported dates MUST match the filename dates shown above": "התאריכים המיוצאים חייבים להתאים לתאריכי שם הקובץ המוצגים לעיל",
      "Only logs OLDER than 90 days will be affected": "רק רשומות ישנות מ-90 ימים יהיו מושפעות",
      "Upload the exported ZIP to Google Drive immediately for backup": "העלה את קובץ ZIP המיוצא ל-Google Drive מיד לגיבוי",
      "The filename includes the exact export timestamp for audit purposes": "שם הקובץ כולל את חותמת הזמן המדויקת לצורכי ביקורת",
      "I understand that this action will permanently delete": "אני מבין שפעולה זו תמחק לצמיתות",
      "audit log records older than 90 days. I have saved the exported CSV as backup.": "רשומות יומן מערכת ישנות מ-90 ימים. שמרתי את ה-CSV המיוצא כגיבוי.",
      "Export & Purge": "ייצוא וניקוי",
      "No audit logs older than 90 days to purge": "אין רשומות יומן מערכת ישנות מ-90 ימים לניקוי",
      "audit logs exported successfully to": "רשומות יומן המערכת יוצאו בהצלחה אל",
      "No deletion has occurred yet.": "לא בוצעה כל מחיקה עדיין.",
      "Check Google Drive for backup.": "בדוק את Google Drive לגיבוי.",
      ...
      "Update email address": "עדכן כתובת דוא״ל (אופציונלי)",
      "Enter new email address": "הזן כתובת דוא״ל חדשה",
      ...
      'Access granted to selected users.': 'הגישה ניתנה למשתמשים שנבחרו',
      "Your account is temporarily suspended. Please contact the administrator.": "חשבונך מושהה זמנית. אנא צור קשר עם מנהל המערכת.",
      "suspended": "מושהה",
      "Show Suspended Users": "הצג מושהים",
      "Showing Suspended": "מציג מושהים",
      "Thaw Selected Users": "אפשר גישה למשתמשים שנבחרו",
      "Grant Access to Selected Users": "אפשר גישה למשתמשים שנבחרו",
      "Grant Access to Suspended Users": "אפשר גישה למשתמשים המושהים",
      "You are about to grant access to": "אתה עומד להעניק גישה ל",
      "suspended user(s)": "משתמש(ים) מושהה(ים)",
      "These users will be able to log in and access the system.": "משתמשים אלה יוכלו להתחבר ולהשתמש במערכת.",
      "Grant Access": "אפשר גישה",
      ...
      "Export Old Audit Logs": "ייצוא יומנים ישנים",
      "Data Summary": "סיכום נתונים",
      "Records to Export": "רשומות לייצוא",
      "Date Range": "טווח תאריכים לניקוי",
      "Cutoff Date (90 days)": "תאריך חיתוך (90 ימים)",
      "Export Filename": "שם קובץ הייצוא",
      "Important Information": "מידע חשוב",
      "All data will be exported to CSV and zipped before deletion": "כל הנתונים יוצאו ל- CSV ויוכנסו לקובץ ZIP לפני המחיקה",
      "Check the 1st and last items in the CSV to verify the correct date range": "בדוק את הפריטים הראשון והאחרון ב- CSV כדי לוודא את טווח התאריכים הנכון",
      "The exported dates MUST match the filename dates shown above": "התאריכים המיוצאים חייבים להתאים לתאריכי שם הקובץ המוצגים למעלה",
      "Only logs OLDER than 90 days will be affected": "רק יומנים שעברו יותר מ- 90 ימים יהיו מושפעים",
      "Upload the exported ZIP to Google Drive immediately for backup": "העלה את קובץ ה- ZIP המיוצא ל- Google Drive באופן מיידי לגיבוי",
      "The filename includes the exact export timestamp for audit purposes": "שם הקובץ כולל את חותמת הזמן המדויקת של הייצוא למטרות ביקורת",
      "I understand that this action will permanently delete": "אני מבין שפעולה זו תמחק באופן קבוע",
      "audit log records older than 90 days. I have saved the exported CSV as backup.": "רשומות יומן ביקורת שעברו יותר מ- 90 ימים. שמרתי את ה- CSV המיוצא כגיבוי.",
      "Export & Purge": "נקה את הקבצים",
      "No audit logs older than 90 days to purge": "אין יומנים ישנים מעל 90 ימים לניקוי",
      "Cancel": "ביטול",
      "Source IP": "כתובת IP",
      "Success": "הצלחה",
      "Failed": "נכשל",
      "audit logs exported and DELETED": "יומני תיעוד נוקו",
      "Backup file": "קובץ גיבוי",
      "Old records permanently removed from database": "רשומות ישנות נוקו לצמיתות מהמערכת",
      'Purge failed': 'ניקוי נכשל',
      "Import Volunteers": "ייבא מתנדבים",
      "Select a file": "בחר קובץ",
      "Please select a file": "אנא בחר קובץ",
      "Please select an .xlsx file": "אנא בחר קובץ .xlsx",
      "Select Excel File": "בחר קובץ Excel",
      "Select Excel File (.xlsx)": "בחר קובץ Excel (.xlsx)",
      "Dry Run": "בדיקה בלבד",
      "Dry Run (Preview)": "בדיקה בלבד (תצוגה מקדימה)",
      "Preview without importing": "תצוגה מקדימה ללא ייבוא",
      "Import": "ייבא",
      "Processing": "מעבד",
      "Validate": "בדוק",
      "Instructions": "הוראות",
      "Excel file must have columns: שם פרטי, שם משפחה, תעודת זהות, מייל, סוג התנדבות, etc.": "קובץ Excel חייב להכיל עמודות: שם פרטי, שם משפחה, תעודת זהות, מייל, סוג התנדבות, וכו'",
      "First do a dry-run to validate data": "קודם בצע בדיקה כדי לאמת את הנתונים",
      "Then upload without dry-run to import": "לאחר מכן העלה ללא בדיקה כדי לייבא",
      ...
      "City": "עיר",
      "years": "שנים",
      "For use of management staff only": "לשימוש צוות הנהלה בלבד",
      "Optional demographic fields for reporting": "שדות דמוגרפיים אופציונליים לצורך דיווח",
      "Not available for Tutor or General Volunteer only roles": "לא זמין עבור תפקידי חונך או מתנדב כללי בלבד",
      "Demographic Information": "פרטים דמוגרפיים",
      "Basic Information": "מידע בסיסי",
      "Staff Information": "פרטי משתמש",
      "View staff information": "הצג פרטי משתמש",
      // Mail sending feature translations
      "Send Mail": "שלח דוא\"ל",
      "Send email to this user": "שלח דוא\"ל למשתמש זה",
      "Send Email": "שלח דוא\"ל",
      "Mail sending": "שליחת דוא\"ל",
      "TO": "אל",
      "Subject": "נושא",
      "Body": "תוכן",
      "Attachments": "קבצים מצורפים",
      'Sending mail...': 'המייל בשליחה...',
      "Email subject": "נושא הדוא\"ל",
      "Email body": "תוכן הדוא\"ל",
      "Separate multiple emails with commas": "הפרד בין כתובות דוא\"ל מרובות בפסיקים",
      "Drag and drop files here or click to select (PNG, JPG, PDF, XLS - Max 10MB total)": "גרור וזרוק קבצים כאן או לחץ לבחירה (PNG, JPG, PDF, XLS - עד 10MB בסה\"כ)",
      "Files selected": "קבצים שנבחרו",
      "TO field is required": "שדה אל חובה",
      "Please enter at least one email address": "אנא הזן לפחות כתובת דוא\"ל אחת",
      "Invalid email format": "פורמט דוא\"ל לא תקין",
      "Subject is required": "נושא חובה",
      "Subject must be maximum 50 characters": "הנושא חייב להיות עד 50 תווים",
      "Body is required": "התוכן חובה",
      "Body must be maximum 250 characters": "התוכן חייב להיות עד 250 תווים",
      "Invalid file type": "סוג קובץ לא תקין",
      "File too large": "הקובץ גדול מדי",
      "Total attachment size exceeds 10MB limit": "סך כל גודל הקבצים חוצה את גבול 10MB",
      "Email sent successfully": "הדוא\"ל נשלח בהצלחה",
      "Failed to send email": "שליחת הדוא\"ל נכשלה",
      "An error occurred while sending the email. Please try again.": "אירעה שגיאה בעת שליחת הדוא\"ל. אנא נסה שוב.",
      "Characters": "תווים",
      "broadcast_mode": "שלח הודעה לכמה רכזים",
      "message_placeholder": "הודעה...",
      "selected": "נבחרים",
      "sending_ellipsis": "שולח...",
      "send_all": "שלח לכולם",
      "conversations": "שיחות",
      "no_messages": "אין הודעות עדיין",
      "no_messages_yet": "אין הודעות עדיין בשיחה זו",
      "select_coordinator": "בחר רכז להתחיל שיחה",
      "Team Updates": "עדכוני צוות",
      "loading": "טוען...",
      ...
      // Refunds module
      "שגיאה בטעינת הנתונים": "שגיאה בטעינת הנתונים",
      "שגיאה בייבוא הקובץ": "שגיאה בייבוא הקובץ",
      "שגיאה בהעלאת הקובץ": "שגיאה בהעלאת הקובץ",
      "שגיאה ביצירת הבקשה": "שגיאה ביצירת הבקשה",
      "שגיאה בעדכון הבקשה": "שגיאה בעדכון הבקשה",
      "שגיאה במחיקת הבקשה": "שגיאה במחיקת הבקשה",
      "בקשת ההחזר נוצרה בהצלחה": "בקשת ההחזר נוצרה בהצלחה",
      "בקשת ההחזר עודכנה בהצלחה": "בקשת ההחזר עודכנה בהצלחה",
      "בקשת ההחזר נמחקה": "בקשת ההחזר נמחקה",
      "Missing required fields: expense_date": "חסר תאריך הוצאה",
      "Missing required fields: requested_amount": "חסר סכום מבוקש",
      "Missing required fields: description": "חסר תיאור",
      "requested_amount must be a positive number.": "הסכום המבוקש חייב להיות מספר חיובי",
      "approved_amount must be a valid number.": "הסכום שאושר אינו תקין",
      "refund_method is required when status is 'שולם'.": "אמצעי תשלום נדרש כאשר הסטטוס הוא שולם",
      "approved_amount is required when status is 'אושר חלקית'.": "סכום שאושר נדרש בעת אישור חלקי",
      "phone_number must be a valid Israeli phone number (e.g. 0541234567).": "מספר טלפון ישראלי לא תקין",
      "Receipt upload is not configured.": "העלאת קבלה אינה מוגדרת",
      "בקשת ההחזר לא נמצאה.": "בקשת ההחזר לא נמצאה.",
      "ניתן לערוך בקשה רק כאשר הסטטוס הוא 'ממתין'.": "ניתן לערוך בקשה רק כאשר הסטטוס הוא 'ממתין'.",
      "שגיאת שרת. אנא נסה שוב.": "שגיאת שרת. אנא נסה שוב.",
    }
  }
};
